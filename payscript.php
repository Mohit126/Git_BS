<?php
include("C:/xampp/htdocs/Book/function/functions.php");
session_start();
 $apiKey = "rzp_test_eUiBuX1VYTYZ3s";
?>
...
<script
    ...
    data-amount="<?php echo 870 * 100;?>" // Amount is in currency subunits. Hence, 29935 refers to 29935 paise or ₹299.35.
